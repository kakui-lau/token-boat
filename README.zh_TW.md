...
<p align="center">
  <strong>感謝 <a href="https://www.jetbrains.com/?from=token-boat">JetBrains</a> 為本項目提供免費的開源開發許可證</strong>
</p>
...
> [!TIP]
> **最新版 Docker 鏡像：** `calciumion/token-boat:latest`
...
| `PYROSCOPE_APP_NAME` | Pyroscope 應用名                                        | `token boat` |
