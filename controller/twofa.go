...
func Setup2FA(c *gin.Context) {
	...
	// 记录操作日志
	model.RecordLogWithIP(userId, model.LogTypeSystem, "开始设置两步验证", c.ClientIP())
...
func Enable2FA(c *gin.Context) {
	...
	// 记录操作日志
	model.RecordLogWithIP(userId, model.LogTypeSystem, "成功启用两步验证", c.ClientIP())
...
func Disable2FA(c *gin.Context) {
	...
	// 记录操作日志
	model.RecordLogWithIP(userId, model.LogTypeSystem, "禁用两步验证", c.ClientIP())
...
func RegenerateBackupCodes(c *gin.Context) {
	...
	// 记录操作日志
	model.RecordLogWithIP(userId, model.LogTypeSystem, "重新生成两步验证备用码", c.ClientIP())
