# token boat Electron Desktop App

This directory contains the Electron wrapper for token boat, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/token boat/data/`
  - Windows: `%APPDATA%/token boat/data/`
  - Linux: `~/.config/token boat/data/`
