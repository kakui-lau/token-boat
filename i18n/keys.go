...
const (
	...
	MsgDistributorPricingCatalogUnavailable     = "distributor.pricing_catalog_unavailable"
	MsgDistributorModelNotFound                 = "distributor.model_not_found"
	MsgDistributorModelDisabled                 = "distributor.model_disabled"
	MsgDistributorModelNotAvailableInGroup      = "distributor.model_not_available_in_group"
	MsgDistributorChannelModelMissing           = "distributor.channel_model_missing"
	MsgDistributorPurchasePriceMissing          = "distributor.purchase_price_missing"
	MsgDistributorPurchasePriceInvalid          = "distributor.purchase_price_invalid"
	MsgDistributorPurchaseContractMismatch      = "distributor.purchase_contract_mismatch"
	MsgDistributorSalesPurchaseContractMismatch = "distributor.sales_purchase_contract_mismatch"
	MsgDistributorPricingConfigurationInvalid   = "distributor.pricing_configuration_invalid"
	MsgDistributorSalesPriceBookUnavailable     = "distributor.sales_price_book_unavailable"
	MsgDistributorSalesPriceMissing             = "distributor.sales_price_missing"
	MsgDistributorMinimumMarginNotMet           = "distributor.minimum_margin_not_met"
	MsgDistributorPricingCalculationFailed      = "distributor.pricing_calculation_failed"
	MsgDistributorNoCompatibleChannel           = "distributor.no_compatible_channel"
