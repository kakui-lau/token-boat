...
const (
	...
	ErrorCodePricingCatalogUnavailable     ErrorCode = "pricing_catalog_unavailable"
	ErrorCodeModelDisabled                 ErrorCode = "model_disabled"
	ErrorCodeModelNotAvailableInGroup      ErrorCode = "model_not_available_in_group"
	ErrorCodeChannelModelMissing           ErrorCode = "channel_model_missing"
	ErrorCodePurchasePriceMissing          ErrorCode = "purchase_price_missing"
	ErrorCodePurchasePriceInvalid          ErrorCode = "purchase_price_invalid"
	ErrorCodePurchaseContractMismatch      ErrorCode = "purchase_contract_mismatch"
	ErrorCodeSalesPurchaseContractMismatch ErrorCode = "sales_purchase_contract_mismatch"
	ErrorCodePricingConfigurationInvalid   ErrorCode = "pricing_configuration_invalid"
	ErrorCodeSalesPriceBookUnavailable     ErrorCode = "sales_price_book_unavailable"
	ErrorCodeSalesPriceMissing             ErrorCode = "sales_price_missing"
	ErrorCodeMinimumMarginNotMet           ErrorCode = "minimum_margin_not_met"
	ErrorCodePricingCalculationFailed      ErrorCode = "pricing_calculation_failed"
	ErrorCodeNoCompatibleChannel           ErrorCode = "no_compatible_channel"
