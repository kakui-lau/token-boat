...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		pricingAdminRoute.Use(middleware.AdminAuth())
		{
			...
			pricingAdminRoute.GET("/sales-price-generator/channel-models", middleware.RequirePermission(authz.PricingRead), controller.AdminListSalesPriceGeneratorChannelModels)
			pricingAdminRoute.POST("/sales-price-generator/generate", middleware.RequirePermission(authz.PricingRead), controller.AdminGenerateSalesPrices)
			pricingAdminRoute.POST("/sales-price-generator/export", middleware.RequirePermission(authz.PricingExport), controller.AdminExportGeneratedSalesPrices)
			...
			pricingAdminRoute.PUT("/model-runtime", middleware.RequirePermission(authz.PricingWrite), controller.AdminSetPricingModelRuntime)
			pricingAdminRoute.GET("/model-price-overview", middleware.RequirePermission(authz.PricingRead), controller.AdminListModelPriceOverview)
			...
			pricingAdminRoute.POST("/official-prices/import-legacy", middleware.RequirePermission(authz.PricingWrite), controller.AdminImportLegacyOfficialPriceDrafts)
			...
			pricingAdminRoute.GET("/retail-prices", middleware.RequirePermission(authz.PricingRead), controller.AdminListRetailPriceVersions)
			pricingAdminRoute.POST("/retail-prices", middleware.RequirePermission(authz.PricingWrite), controller.AdminCreateRetailPriceVersion)
			pricingAdminRoute.POST("/retail-prices/:id/publish", middleware.RequirePermission(authz.PricingPublish), controller.AdminPublishRetailPriceVersion)
			pricingAdminRoute.POST("/retail-prices/:id/suspend", middleware.RequirePermission(authz.PricingPublish), controller.AdminSuspendRetailPriceVersion)
			pricingAdminRoute.DELETE("/retail-prices/:id", middleware.RequirePermission(authz.PricingWrite), controller.AdminDeleteRetailPriceDraft)
			pricingAdminRoute.POST("/drafts/retail", middleware.RequirePermission(authz.PricingWrite), controller.AdminCreateStructuredRetailPriceDraft)
			pricingAdminRoute.PUT("/drafts/retail/:id", middleware.RequirePermission(authz.PricingWrite), controller.AdminUpdateStructuredRetailPriceDraft)
			pricingAdminRoute.POST("/simulate", middleware.RequirePermission(authz.PricingRead), controller.AdminSimulatePrice)
			pricingAdminRoute.GET("/active-price-bundle", middleware.RequirePermission(authz.PricingRead), controller.AdminGetActivePriceBundle)
		}
