...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		pricingAdminRoute.Use(middleware.RootAuth())
		{
			...
			pricingAdminRoute.POST("/request-pricing-snapshots/:id/provider-cost", controller.AdminRecordProviderReportedCost)
			...
			pricingAdminRoute.GET("/circuit-events", controller.AdminListPricingCircuitEvents)
			pricingAdminRoute.POST("/circuit-overview/:channel_id/reset", controller.AdminResetPricingCircuit)
			pricingAdminRoute.PUT("/model-runtime", controller.AdminSetPricingModelRuntime)
			...
			pricingAdminRoute.PUT("/official-prices/:id", controller.AdminUpdateOfficialPriceVersionDraft)
			pricingAdminRoute.POST("/official-prices/sync", controller.AdminSyncOfficialPrices)
			pricingAdminRoute.GET("/official-prices/sync-batches", controller.AdminListOfficialPriceSyncBatches)
			...
			pricingAdminRoute.POST("/purchase-prices/:id/suspend", controller.AdminSuspendPurchasePriceVersion)
			pricingAdminRoute.DELETE("/purchase-prices/:id", controller.AdminDeletePurchasePriceDraft)
			pricingAdminRoute.POST("/drafts/purchase", controller.AdminCreateStructuredPurchasePriceDraft)
			pricingAdminRoute.PUT("/drafts/purchase/:id", controller.AdminUpdateStructuredPurchasePriceDraft)
			...
			pricingAdminRoute.POST("/retail-prices/:id/suspend", controller.AdminSuspendRetailPriceVersion)
			pricingAdminRoute.DELETE("/retail-prices/:id", controller.AdminDeleteRetailPriceDraft)
			pricingAdminRoute.POST("/drafts/retail", controller.AdminCreateStructuredRetailPriceDraft)
			pricingAdminRoute.PUT("/drafts/retail/:id", controller.AdminUpdateStructuredRetailPriceDraft)
			pricingAdminRoute.POST("/simulate", controller.AdminSimulatePrice)
			pricingAdminRoute.GET("/active-price-bundle", controller.AdminGetActivePriceBundle)
		}
