...
export const ModelPerfBadge = memo(function ModelPerfBadge(
  ...
  const statusBars = [
    { id: 'oldest', rate: paddedStatusRates[0], height: 'h-2' },
    { id: 'middle', rate: paddedStatusRates[1], height: 'h-2.5' },
    { id: 'latest', rate: paddedStatusRates[2], height: 'h-3' },
  ]
