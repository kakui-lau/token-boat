    ...
    <AuthLayout>
      <div className='w-full space-y-8'>
        <div className='space-y-2'>
          <h2 className='from-foreground via-primary to-secondary bg-gradient-to-r bg-clip-text text-center text-3xl font-semibold tracking-tight text-transparent sm:text-left'>
            {t('Sign in')}
          </h2>
