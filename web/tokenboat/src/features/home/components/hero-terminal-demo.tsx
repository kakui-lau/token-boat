...
export function HeroTerminalDemo(props: HeroTerminalDemoProps) {
  ...
  return (
    <div className={cn('mx-auto w-full max-w-2xl', props.className)}>
      <div
        className={cn(
          'token-boat-glow-card overflow-hidden rounded-2xl border backdrop-blur-xl',
          'border-primary/20 bg-background/82 shadow-[0_24px_70px_-34px_color-mix(in_oklch,var(--secondary)_50%,transparent)]',
          'dark:border-primary/18 dark:bg-background/72 dark:shadow-[0_24px_80px_-34px_color-mix(in_oklch,var(--primary)_45%,transparent)]'
        )}
      >
        {/* Tab strip */}
        <div
