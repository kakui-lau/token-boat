    ...
    <button
      ...
      className={cn(
        ...
        props.active
          ...
          : 'border-primary/10 bg-background/68 text-muted-foreground hover:border-primary/25 hover:bg-background hover:text-foreground'
      )}
...
function FilterSection(props: FilterSectionProps) {
  return (
    <Collapsible defaultOpen className='bg-background/45 rounded-2xl p-3'>
