...
function SegmentedControl(props: {
  ...
  return (
    <div
      ...
      className='border-primary/10 bg-background/70 inline-flex h-8 items-center rounded-full border p-0.5'
    >
      {props.options.map((option) => {
        ...
        const button = (
          <button
            ...
            className={cn(
              'inline-flex h-full items-center justify-center rounded-full text-xs font-medium transition-all',
...
export function PricingToolbar(props: PricingToolbarProps) {
  ...
  return (
    <div className='border-primary/10 bg-background/72 rounded-2xl border p-3 shadow-[0_18px_60px_-50px_color-mix(in_oklch,var(--secondary)_70%,transparent)] backdrop-blur-xl'>
