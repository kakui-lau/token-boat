  ...
  return (
    <div className={cn('relative', props.className)}>
      ...
      <input
        ...
        className={cn(
          'border-primary/15 bg-background/78 placeholder:text-muted-foreground/50 shadow-[0_22px_60px_-45px_color-mix(in_oklch,var(--primary)_85%,transparent)] backdrop-blur-xl',
