...
export function MarketShareSection(props: MarketShareSectionProps) {
  ...
  return (
    <section className='token-boat-glow-card border-primary/10 bg-background/74 overflow-hidden rounded-3xl border shadow-[0_30px_100px_-70px_color-mix(in_oklch,var(--secondary)_75%,transparent)] backdrop-blur-xl'>
      {/* Chart block ----------------------------------------------------- */}
      ...
      <div className='border-primary/10 border-t bg-background/40'>
        ...
        {visible.length === 0 ? (
          ...
          <div className='grid grid-cols-1 gap-3 px-5 pt-1 pb-5'>
