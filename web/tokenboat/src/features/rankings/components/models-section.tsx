...
export function ModelsSection(props: ModelsSectionProps) {
  ...
  return (
    <section className='token-boat-glow-card border-primary/10 bg-background/74 overflow-hidden rounded-3xl border shadow-[0_30px_100px_-70px_color-mix(in_oklch,var(--primary)_75%,transparent)] backdrop-blur-xl'>
      {/* Chart block ----------------------------------------------------- */}
