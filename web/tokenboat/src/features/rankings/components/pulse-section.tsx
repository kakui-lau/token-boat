...
function PulseCard(props: {
  ...
  return (
    <div className='token-boat-glow-card border-primary/10 bg-background/74 overflow-hidden rounded-3xl border shadow-[0_28px_90px_-72px_color-mix(in_oklch,var(--primary)_70%,transparent)] backdrop-blur-xl'>
      <header className='border-primary/10 border-b px-5 py-4'>
...
function MoverRow(props: { row: RankingMover; intent: 'up' | 'down' }) {
  return (
    <li className='bg-background/52 border-primary/8 flex items-center gap-3 rounded-2xl border px-3 py-2.5'>
