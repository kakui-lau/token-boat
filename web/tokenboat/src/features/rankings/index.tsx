  ...
  return (
    <PublicLayout showMainContainer={false}>
      <div className='token-boat-home relative overflow-hidden'>
        ...
        <PageTransition className='relative mx-auto w-full max-w-[1320px] space-y-8 px-3 pt-16 pb-10 sm:px-6 sm:pt-20 sm:pb-12 xl:px-8'>
          ...
          {rankingsQuery.isLoading ? (
            ...
            <>
              <div className='grid gap-5 xl:grid-cols-[1.18fr_0.82fr] xl:items-start'>
                <ModelsSection
